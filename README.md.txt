In order to run this python script we need to install the following libraries:
pillow
pytesseract
opencv-python
tkinter
and run visual studio code.
in order to install this you can use the command: pip install pillow  and etc... in visual studio terminal
or this: pip install -r requirements.txt
